# from .core_actions import arrive_room
...
#     live_game_state.connections_.append(new_connection)
...
#     chardef = live_game_state.world_definition_.find_character_definition("test_player")
...
#     live_game_state.players_.append(new_player)
#     # print(YamlDumper.to_yaml_compatible_str(operating_state.zones_))
#     first_zone = live_game_state.zones_[list(live_game_state.zones_.keys())[0]]
...
#     for c in live_game_state.connections_:
#         if c.consumer_ == consumer:
#             remove_character(c)
#             live_game_state.connections_.remove(c)
#             return
        

# def remove_character(self, connection: Connection):
#     live_game_state.players_.remove(connection.character)
