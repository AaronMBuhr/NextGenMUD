...
class PlayerSaveManager:
    ...
    def _apply_data_to_character(self, data: Dict[str, Any], character: 'Character',
        ...
        try:
            ...
            character.set_hp_to(data.get('current_hit_points', character.max_hit_points))
            character.max_mana = data.get('max_mana', 0)
            character.set_mana_to(data.get('current_mana', character.max_mana))
            character.max_stamina = data.get('max_stamina', 0)
            character.set_stamina_to(data.get('current_stamina', character.max_stamina))
